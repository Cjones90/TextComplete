...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextComplete = __webpack_require__(1);
	...
	var Example = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(TextComplete, { id: "example", divClass: "example", target: "#example2",
	      ...
	      React.createElement(
	        "span",
	        null,
	        "Here's an example with some random names!  "
	      ),
	      React.createElement(TextComplete, { id: "example2", divClass: "example2", array: "names", target: "#example",
	        placeHolder: "Names", selectListSize: "8", ref: "myVal2" }),
	      React.createElement("br", null),
	      React.createElement(
	        "span",
	        null,
	        "Here's an example with the minimum required options! "
	      ),
	      React.createElement(TextComplete, { divClass: "example3", array: "names", selectListSize: "8" })
	    );
	  }

	});

	React.render(React.createElement(Example, null), document.getElementById("index"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stateArr = ["Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississippi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Caolina", "North Dakota", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming"];

	var nameArr = ["Chrissy", "Clay", "Monica", "Ettie", "Minta", "Verline", "Kathern", "Esther", "Emil", "Parker", "Tyesha", "Genna", "Emelda", "Tamica", "Alena", "Kathy", "Kenton", "Jospeh", "Marlene", "Isabell", "Adelaide", "Slyvia", "Cathleen", "Alana", "Deann", "Janina", "Jame", "Raymond", "Shellie", "Monnie"];
	//
	// const host = 'http://localhost:5000';

	var TextComplete = React.createClass({
	  displayName: "TextComplete",
	  ...
	  queryArray: function queryArray(array) {
	    if (array === "states") {
	  ...
	  checkBlur: function checkBlur(e) {
	    ...
	    //When input/option unfocused, check value of next target
	    if (e.relatedTarget === null || e.relatedTarget.tagName.toLowerCase() !== "option" && e.relatedTarget.tagName.toLowerCase() !== "select") {
	  ...
	  checkKey: function checkKey(e) {
	    ...
	    if (e.key === "ArrowUp" || e.key === "ArrowDown") {
	      var select = document.querySelector("#" + e.target.dataset["class"]);
	      var option = select.options[select.selectedIndex].focus();
	    }
	  },

	  fillField: function fillField(e) {
	    //Get the appropriate input box (in-case of multiple per page)
	    var input = document.querySelector("[data-id=" + e.target.dataset["class"] + "]");
	    ...
	    document.querySelector(e.target.getAttribute("target")) ? document.querySelector(e.target.getAttribute("target")).focus() : null;
	  },
	  ...
	  checkInput: function checkInput(e) {
	    ...
	    if (e.key === "Tab") {
	      ...
	      var _length = document.querySelector("#" + e.target.dataset["class"]).options.length;
	      //If there is only one element left in the list (filtered down appropriately)
	      if (_length === 1) {
	        //Get it's value
	        var val = document.querySelector("#" + e.target.dataset["class"]).options[0].value;
	  ...
	  render: function render() {
	    ...
	    var optionVals = this.state.inputArr.map(function (option, i) {
	      if (option.toLowerCase().indexOf(_this.state.input.toLowerCase()) === 0) {
	        return React.createElement(
	          "option",
	          { tabIndex: "0",
	            "data-class": _this.state.inputComponent, target: _this.props.target,
	            key: option + i,
	            onFocus: _this.checkFocus,
	            onClick: _this.fillField,
	            onBlur: _this.checkBlur,
	            onKeyUp: _this.checkKey
	          },
	          option
	        );
	      }
	    ...
	    var selectObject = this.state.active ? React.createElement(
	      "select",
	      { tabIndex: "1", id: this.state.inputComponent,
	    ...
	    return React.createElement(
	      "div",
	      { className: this.props.divClass, style: { display: "inline-block", position: "relative", boxSizing: "content-box" } },
	      React.createElement("input", { style: { width: "100%" }, type: "text",
